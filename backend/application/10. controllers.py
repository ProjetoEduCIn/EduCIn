...
from app.domain.entities import Aluno, Cadeira
from app.infrastructure.repositories import AlunoRepository
from app.application.dtos import AlunoCreateDTO, AlunoResponseDTO
from app.application.auth import verificar_dominio
